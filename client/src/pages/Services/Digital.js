...
import { listServicesSolutions } from '../../infos/infos'
...
const DigitalSolutions = () => {
    ...
    const renderizaNaTela = listServicesSolutions.list.map((service) => {
        return (
            <CardItemService>
    ...
    return (
        <div>
            ...
            >
                <TitleServices>Soluções Digitais</TitleServices>
            </Animated>
