...
import { listServicesEngineer } from '../../infos/infos'
...
const EngineeringServices = () => {
    ...
    const renderizaNaTela = listServicesEngineer.list.map((service) => {
        return (
            <CardItemService>
    ...
    return (
        <div>
            ...
            >
                <TitleServices>Serviços de Engenharia</TitleServices>
            </Animated>
