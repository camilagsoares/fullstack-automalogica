...
import { listServicesOperation } from '../../infos/infos'
...
const Operation = () => {
    ...
    const renderizaNaTela = listServicesOperation.list.map((service) => {
        return (
    ...
    return (
        <div>
            ...
            >
                <TitleServices>Operação de Sistemas Elétricos</TitleServices>
            </Animated>
