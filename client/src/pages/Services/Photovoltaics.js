...
import { listServicesPhotovoltaic } from '../../infos/infos'
...
const Photovoltaics = () => {
    ...
    const renderizaNaTela = listServicesPhotovoltaic.list.map((service) => {
        return (
            <CardItemService>
    ...
    return (
        <div>
            ...
            >
                <TitleServices>Digitalização de fotovoltaicas</TitleServices>
            </Animated>
            <Animated
                animation={{
